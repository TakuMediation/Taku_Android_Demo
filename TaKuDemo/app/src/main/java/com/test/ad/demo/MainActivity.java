...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        int viewId = v.getId();
        if (viewId == R.id.nativeBtn) {
            adPageClass = NativeMainActivity.class;
        } else if (viewId == R.id.splashBtn) {
            adPageClass = SplashAdActivity.class;
        } else if (viewId == R.id.interstitialBtn) {
            adPageClass = InterstitialAdActivity.class;
        } else if (viewId == R.id.bannerBtn) {
            adPageClass = BannerAdActivity.class;
        } else if (viewId == R.id.rewardedVideoBtn) {
