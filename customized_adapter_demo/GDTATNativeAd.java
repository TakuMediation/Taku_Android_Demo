    ...
    public void prepare(View view, ATNativePrepareInfo nativePrepareInfo) {
        if (mUnifiedAdData != null && mContainer != null) {
            ...
            try {
                ...
                mUnifiedAdData.bindMediaView(mMediaView, new VideoOption.Builder().setAutoPlayMuted(mVideoMuted == 1).setDetailPageMuted(mVideoMuted == 1).setAutoPlayPolicy(mVideoAutoPlay).build(), new NativeADMediaListener() {
                    @Override
